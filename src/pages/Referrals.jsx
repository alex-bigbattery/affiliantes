...
export default function Referrals() {
  ...
  const view = searchParams.get('view') === 'wp' ? 'wp' : 'orders'
  ...
  }, [wpView, status, search, affId, dateFrom, dateTo, monthFilter, offset])
  ...
  const tableHeaders = wpView
    ? ['Referral', 'Date', 'Affiliate', 'WC #', 'Order', 'Commission', 'Status', 'Ledger', 'Actions']
    : ['Order', 'Date', 'Affiliate', 'Coupon', 'WC #', 'Commission', 'Status', 'Actions']
        ...
        <div className="card overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              {loading
                ? <tr><td colSpan={tableHeaders.length + 1}><Spinner /></td></tr>
                : referrals.length === 0
                  ? <tr><td colSpan={tableHeaders.length + 1}><Empty label="No rows for these filters" /></td></tr>
                  : referrals.map(r => {
