...
function MfaEnroll({ onDone }) {
  ...
  return (
    <AuthShell
      ...
      subtitle="Scan the QR code with Google Authenticator, Authy, or 1Password. Then enter the 6-digit code to finish."
    >
      <div className="grid sm:grid-cols-2 gap-6 items-start">
        ...
        <form onSubmit={verify} className="space-y-4">
          ...
          <AuthSubmit loading={loading} loadingText="Enabling…" disabled={code.length < 6}>
            Enable 2FA &amp; continue
          </AuthSubmit>
        </form>
      </div>
